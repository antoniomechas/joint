...
void testApp::setup() {
	...
	circleMovil.setPhysics(3.0, 0.53, 0.1);
	circleMovil.setup(box2d.getWorld(), ofGetWidth() /2, ofGetHeight() / 2, 40);

	circleJoint.setWorld(box2d.getWorld());
	circleJoint.addJoint(box2d.ground, circleMovil.body);
